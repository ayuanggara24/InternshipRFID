...
function stateChanged(){
  ...
  if (ajaxku.readyState==4){
    ...
    if(data.length>=0){
      ...
      document.getElementById("kota").value = "<option selected></option>";
    }
...
function stateChangedKec(){
  ...
  if (ajaxku.readyState==4){
    ...
    if(data.length>=0){
      ...
      document.getElementById("kec").value = "<option selected></option>";
    }
...
function stateChangedKel(){
  ...
  if (ajaxku.readyState==4){
    ...
    if(data.length>=0){
      ...
      document.getElementById("kel").value = "<option selected></option>";
    }
